class ValentinesDayDelievery < ActiveRecord::Base
  ...
  validate :enough_red_flowers, :on => :create
  validate :enough_white_flowers, :on => :create
  validate :enough_pink_flowers, :on => :create
  validate :enough_large_stuffed_animals, :on => :create
  validate :enough_medium_stuffed_animals, :on => :create
  validate :enough_small_stuffed_animals, :on => :create

  def enough_red_flowers
  ...
  def enough_large_stuffed_animals
    inventory = ValentinesDayInventory.where(current_year: Time.now.year.to_s).first
  ...
  def enough_medium_stuffed_animals
    inventory = ValentinesDayInventory.where(current_year: Time.now.year.to_s).first
  ...
  def enough_small_stuffed_animals
    inventory = ValentinesDayInventory.where(current_year: Time.now.year.to_s).first
