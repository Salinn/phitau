...
RSpec.describe "valentines_day_inventories/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit valentines_day_inventory form" do
    render

    assert_select "form[action=?][method=?]", valentines_day_inventory_path(@valentines_day_inventory), "post" do
