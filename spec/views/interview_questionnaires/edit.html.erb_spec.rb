...
RSpec.describe "interview_questionnaires/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit interview_questionnaire form" do
    render

    assert_select "form[action=?][method=?]", interview_questionnaire_path(@interview_questionnaire), "post" do
