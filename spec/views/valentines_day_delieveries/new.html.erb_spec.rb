...
RSpec.describe "valentines_day_delieveries/new", :type => :view do
  before(:each) do
    assign(:valentines_day_delievery, ValentinesDayDelievery.new(
  ...
  it "renders new valentines_day_delievery form" do
    render

    assert_select "form[action=?][method=?]", valentines_day_delieveries_path, "post" do
